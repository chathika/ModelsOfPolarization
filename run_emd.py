...
setup = ['setup']
measurements = ["ticks", "polarization", "standard-deviation [stance] of turtles"]
ticks = 100
...
def fit_func(results):
    return results.iloc[-1].polarization

emd.set_objective_function(fit_func)
...
if __name__ == '__main__':
    emd.evolve()
    fi = emd.get_factor_importances_calculator("FactorScores_Polarization_Max.csv")
